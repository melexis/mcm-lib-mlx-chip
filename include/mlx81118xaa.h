...
const mlx_project_id_t mlx81118xaa_project_ids[] = {
    {.id = 0x1801u, .name = "MLX81118KLW-AAA-x00"},
};

const mlx_flash_t mlx81118xaa_flash = {
    .start = 0x05800u,
    .length = 0x08000u,
    .page = 0x80u,
    .sector = 0x800u,
...
const mlx_flash_cs_t mlx81118xaa_flash_cs = {
    .start = 0x05700u,
    .length = 0x00100u,
    .writeable = 0x80u,
    .page = 0x80u,
...
const mlx_nv_memory_t mlx81118xaa_nv_memory = {
    .start = 0x00800u,
    .length = 0x00238u,
    .writeable = 0x1B0u,
    .page = 0x8u,
