...
const ProjectId_t mlx81118xab_project_ids[] = {
    {.id = 0x1802u, .name = "MLX81118xAB"},
};

const Flash_t mlx81118xab_flash = {
    .start = 0x05800u,
    .length = 0x08000u,
    .page = 0x80u,
    .sector = 0x800u,
...
const FlashCs_t mlx81118xab_flash_cs = {
    .start = 0x05700u,
    .length = 0x00100u,
    .writeable = 0x80u,
    .page = 0x80u,
...
const NvMemory_t mlx81118xab_nv_memory = {
    .start = 0x00800u,
    .length = 0x00238u,
    .writeable = 0x1B0u,
    .page = 0x8u,
