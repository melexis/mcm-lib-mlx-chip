...
const mlx_project_id_t mlx81344b01_project_ids[] = {
    {.id = 0x0C03u, .name = "MLX81344-xLW-BMx-003"},
    {.id = 0x0C04u, .name = "MLX81344-xLW-BMx-103"},
};

const mlx_flash_t mlx81344b01_flash = {
    .start = 0x08000u,
    .length = 0x10000u,
    .page = 0x80u,
    .sector = 0x800u,
...
const mlx_nv_memory_t mlx81344b01_nv_memory = {
    .start = 0x00400u,
    .length = 0x00238u,
    .writeable = 0x1B0u,
    .page = 0x8u,
