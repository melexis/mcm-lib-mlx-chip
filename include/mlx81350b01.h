...
const ProjectId_t mlx81350b01_project_ids[] = {
...
const Flash_t mlx81350b01_flash = {
    .start = 0x05800u,
    .length = 0x08000u,
    .page = 0x80u,
    .sector = 0x800u,
...
const FlashCs_t mlx81350b01_flash_cs = {
    .start = 0x05700u,
    .length = 0x00100u,
    .writeable = 0x80u,
    .page = 0x80u,
...
const NvMemory_t mlx81350b01_nv_memory = {
    .start = 0x00800u,
    .length = 0x00240u,
    .writeable = 0x1B0u,
    .page = 0x8u,
