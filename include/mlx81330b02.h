...
const mlx_project_id_t mlx81330b02_project_ids[] = {
...
const mlx_flash_t mlx81330b02_flash = {
    .start = 0x05800u,
    .length = 0x08000u,
    .page = 0x80u,
    .sector = 0x800u,
