...
const mlx_project_id_t mlx81339a02_project_ids[] = {
    {.id = 0x2503u, .name = "MLX81339-xDC-AMx-202"},
    {.id = 0x2504u, .name = "MLX81339-xLW-AMx-202"},
};

const mlx_flash_t mlx81339a02_flash = {
    .start = 0x05800u,
    .length = 0x08000u,
    .page = 0x80u,
    .sector = 0x800u,
...
const mlx_nv_memory_t mlx81339a02_nv_memory = {
    .start = 0x00800u,
    .length = 0x00400u,
    .writeable = 0x300u,
    .page = 0x80u,
...
const mlx_prog_keys_t mlx81339a02_programming_keys = {
    .length = sizeof(mlx81339a02_programming_keys_values) / sizeof(uint16_t),
    .values = mlx81339a02_programming_keys_values,
};

const mlx_ppm_loader_t mlx81339a02_ppm_loader = {
    .prog_keys = &mlx81339a02_programming_keys,
    .eeprom_verification_session = true,
    .flash_cs_programming_session = false,
};

const mlx_uart_loader_t mlx81339a02_uart_loader = {
    .prog_keys = &mlx81339a02_programming_keys,
};

const mlx_chip_t mlx81339a02 = {
    .name = "MLX81339A02",
    .project_ids = {
        .length = sizeof(mlx81339a02_project_ids) / sizeof(mlx_project_id_t),
