...
const ProjectId_t mlx81340b01_project_ids[] = {
    {.id = 0x0A05u, .name = "MLX81340-xLW-BMx-003"},
    {.id = 0x0A06u, .name = "MLX81340-xLW-BMx-103"},
};

const Flash_t mlx81340b01_flash = {
    .start = 0x08000u,
    .length = 0x08000u,
    .page = 0x80u,
    .sector = 0x800u,
...
const FlashCs_t mlx81340b01_flash_cs = {
    .start = 0x07F00u,
    .length = 0x00100u,
    .writeable = 0x80u,
    .page = 0x80u,
...
const NvMemory_t mlx81340b01_nv_memory = {
    .start = 0x00400u,
    .length = 0x00240u,
    .writeable = 0x1B0u,
    .page = 0x8u,
