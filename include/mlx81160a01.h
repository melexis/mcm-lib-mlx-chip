...
const mlx_project_id_t mlx81160a01_project_ids[] = {
    {.id = 0x1601u, .name = "MLX81160-xLW-AMx-001"},
};

const mlx_flash_t mlx81160a01_flash = {
    .start = 0x08000u,
    .length = 0x08000u,
    .page = 0x80u,
    .sector = 0x800u,
...
const mlx_flash_cs_t mlx81160a01_flash_cs = {
    .start = 0x07F00u,
    .length = 0x00100u,
    .writeable = 0x80u,
    .page = 0x80u,
...
const mlx_nv_memory_t mlx81160a01_nv_memory = {
    .start = 0x00400u,
    .length = 0x00238u,
    .writeable = 0x1B0u,
    .page = 0x8u,
