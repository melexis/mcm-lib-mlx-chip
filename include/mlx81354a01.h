...
const mlx_project_id_t mlx81354a01_project_ids[] = {
...
const mlx_flash_t mlx81354a01_flash = {
    ...
    .write_time = 7,
    .write_partial = true,
    .type = MEM_TYPE_AMALTHEA_XFE2,
};

const mlx_flash_cs_t mlx81354a01_flash_cs = {
    .start = 0x05600u,
    .length = 0x00200u,
    .writeable = 0x100u,
    .page = 0x100u,
...
const mlx_nv_memory_t mlx81354a01_nv_memory = {
    .start = 0x00400u,
    .length = 0x00640u,
    .writeable = 0x5B0u,
    .page = 0x8u,
