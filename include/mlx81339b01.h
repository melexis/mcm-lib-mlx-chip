...
const ProjectId_t mlx81339b01_project_ids[] = {
    {.id = 0x2505u, .name = "MLX81339-xDC-BMx-202"},
    {.id = 0x2506u, .name = "MLX81339-xLW-BMx-202"},
};

const Flash_t mlx81339b01_flash = {
    .start = 0x05800u,
    .length = 0x08000u,
    .page = 0x80u,
    .sector = 0x800u,
...
const NvMemory_t mlx81339b01_nv_memory = {
    .start = 0x00800u,
    .length = 0x00400u,
    .writeable = 0x300u,
    .page = 0x80u,
...
const ProgKeys_t mlx81339b01_programming_keys = {
...
const MlxChip_t mlx81339b01 = {
    .name = "MLX81339B01",
    .project_ids = {
        .length = sizeof(mlx81339b01_project_ids) / sizeof(ProjectId_t),
